...
library(dplyr)
library(ggpubr)
library(BSDA) #También sirve para aplicar la prueba z, pero me
library(TeachingDemos) #Para aplicar la prueba z 
```
...
```{r}
# Con el valor z conseguido, podemos usar el pnorm
valor_normal <- pnorm(-1.95, lower.tail = T)
cat("Valor de la distribución normal: ",valor_normal)
```
